...
import { isUint8Array, randomBytes } from "./utils";
...
export class ObjectId {
   ...
   */
  constructor(
    inputId?: string | number | ObjectId | ObjectIdLike | Buffer | Uint8Array
  ) {
    ...
    if (workingId == null || typeof workingId === "number") {
      ...
      throw new Error("This use-case is not implemented");
  ...
  toString(format?: string): string {
    ...
    if (format) return this.id.toString(format as BufferEncoding);
