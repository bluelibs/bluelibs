...
type CreateUploadLinkOptions = {
  ...
  isExtractableFile?: typeof defaultIsExtractableFile;
...
export default function createUploadLink({
  ...
  useGETForQueries,
  isExtractableFile: customIsExtractableFile = defaultIsExtractableFile,
  // @ts-ignore
  FormData: CustomFormData,
  formDataAppendFile: customFormDataAppendFile = defaultFormDataAppendFile,
  ...
  return new ApolloLink((operation) => {
    ...
    const {
      ...
      clientAwareness: { name, version } = {} as any,
      headers,
    } = context;
